package com.example.demo.config.accesslog;

import com.example.demo.utils.AdrressIpUtils;
...
public class AccessLogInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
        ...
        //设置访问者(这里暂时写死）
        // 因为不同的应用可能将访问者信息放在session里面          request.getSession().getAttribute("username");
        // ，有的通过request传递，
        // 总之可以获取到，但获取的方法不同
